...
climateParams = {
    ...
    models:{
        ...
        "BCC":["bm", "#FF00FF","0",true],
        "CanESM2":["c2","#DEB78B","1",true],
        "CCSM4":["c4","#717573","2",true],
        "CSIRO":["c0","#808000","3",true],
        "HadGEM2CC":["hc","#FF8A09","5",true],
        "HadGEM2ES":["hs","#8080C0","6",true],
        "IPSL":["ir","#8080C0","7",true],
        "MIROC5":["m5","#C6D2DF","8",true],
        "NorESM1":["nm","#C6D2DF","9",true],
        "Ensemble":["ee","red","4",true]},
    labels:{
        "tmax":["Degrees (°C)","°C"],
        "tmad":["Degrees (°C)","°C"],
        "tmaa":["Degrees (°C)","°C"],

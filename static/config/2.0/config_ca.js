...
climateParams={
    ...
    models: {
        ...
        "PRISM": ["pm", "black", "0", true, 6, "circle"],
        "Ensemble": ["ee", "#C0C2C2", "0", true, 6, "circle"],
        "CNRM(Warm/Wet)": ["c5", "#C0C2C2", "5", true, 6, "circle"],
        "CCSM4(Warm/Dry)": ["c4", "#C0C2C2", "2", true, 6, "circle"],
        "CanESM2(Hot/Wet)": ["c2", "#C0C2C2", "6", true, 6, "circle"],
        "HadGEM2ES(Hot/Dry)": ["hs", "#C0C2C2", "9", true, 6, "circle"],
        "ACCESS": ["a0", "#C0C2C2", "1", true, 6, "circle"],
        "CESM1": ["cc", "#C0C2C2", "3", true, 6, "circle"],
        "CMCC": ["cm", "#C0C2C2", "4", true, 6, "circle"],
        "GFDL": ["g3", "#C0C2C2", "7", true, 6, "circle"],
        "HadGEM2CC": ["hc", "#C0C2C2", "6", true, 6, "circle"],
        "MIROC5": ["m5", "#C0C2C2", "10", true, 6, "circle"],
    },
    labels:{
        "tmax":["Degrees (°C)","°C"],
        "tmad":["Degrees (°C)","°C"],

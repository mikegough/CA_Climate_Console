...
reportingUnits={
    ...
    "Counties": ["ca_reporting_units_county_boundaries_5_simplify_hisensfz270","name","CA_Reporting_Units_County_Boundaries_5_simplify.json"],
    "Jepson Ecoregions":["ca_reporting_units_jepson_ecoregions_2_simplify_hisensfz270","name","CA_Reporting_Units_Jepson_Ecoregions_2_simplify.json"],
    "USDA Ecoregions":["ca_reporting_units_bailey_ecoregions_hisensfz270","name","CA_Reporting_Units_Bailey_Ecoregions_2_simplify.json"],
    "BLM Field Offices":["ca_reporting_units_blm_field_offices_7_simplify_hisensfz270", "name", "CA_Reporting_Units_BLM_Field_Offices_7_simplify.json"],
    "HUC5 Watersheds": ["ca_reporting_units_huc5_watersheds_5_simplify_hisensfz270", "name", "CA_Reporting_Units_HUC5_Watersheds_5_simplify.json"],
    "National Forests": ["ca_reporting_units_usfs_nationalforest_15_simplify_hisensfz270","name","CA_Reporting_Units_USFS_National_Forests_15_simplify.json"],
    "User Defined (1km)": ["ca_reporting_units_1km_poly_join_eems_hisensfz270","",""],
};

climateParams={
    timePeriods:2,
    timePeriodLabels:['Historical <br>(1971-2000)', 'Future <br>(2016-2045)', 'Future <br>(2046-2075)'],
    models: {
        ...
        "HadGEM2CC": ["hc", "#C0C2C2", "6", true, 4, "circle"],
...
EEMSParams={
    ...
    models: {
        // NOTE: Also need to enter these field names into the view
        // "Field Code" ["Legend Label", "Legend File Name (without png), "Legend Labels", "Data Basin ID", "EEMS Command File", "Top Node", "Description for Popup", "Bounds to Use (just the number in overlayBoundsX below)"]
    ...
    "overlayBounds3":[[32.34186389317489, -124.5126192723799], [42.07385873272172, -113.49340537869628]]
};

...
climateParams = {
    ...
    models: {
        ...
        "CCSM4(Warm/Dry)": ["c4", "#C0C2C2", "2", true, 4, "triangle-down"],
        "CanESM2(Hot/Wet)": ["c2", "#C0C2C2", "6", true, 4, "square"],
        "HadGEM2ES(Hot/Dry)": ["hs", "#C0C2C2", "9", true, 4, "diamond"],
        "ACCESS": ["a0", "#C0C2C2", "1", true, 4, "triangle"],
        "CESM1": ["cc", "#C0C2C2", "3", true, 4, "triangle-down"],
        "CMCC": ["cm", "#C0C2C2", "4", true, 4, "square"],
        "GFDL": ["g3", "#C0C2C2", "7", true, 4, "diamond"],
        "HadGEM2CC": ["hc", "#C0C2C2", "8", true, 4, "circle"],
        "MIROC5": ["m5", "#C0C2C2", "10", true, 4, "triangle"],
    },
    labels:{
        "tmax":["Degrees (°C)","°C"],
        "tmad":["Degrees (°C)","°C"],

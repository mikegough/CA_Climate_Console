...
climateParams = {
    ...
    models:{"PRISM":["pm","black"], "ACCESS":["a0", "#FF00FF"], "CanESM2":["c2","#DEB78B"],"CCSM4":["c4","#717573"],"CESM1":["cc","#808000"],"CMCC":["cm","#1EED1E"],"CNRM":["c5","#800040"],"GFDL":["g3","#1B6186"],"HadGEM2CC":["hc","#FF8A09"],"HadGEM2ES":["hs","#8080C0"],"MIROC5":["m5","#C6D2DF"],"Ensemble":["ee","red"]},
